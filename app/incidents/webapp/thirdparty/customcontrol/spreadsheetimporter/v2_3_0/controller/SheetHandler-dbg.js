sap.ui.define(["sap/ui/base/ManagedObject", "cc/spreadsheetimporter/v2_3_0/thirdparty/xlsx"], function (ManagedObject, XLSX) {
  "use strict";

  /**
   * @namespace cc.spreadsheetimporter.v2_3_0
   */
  const SheetHandler = ManagedObject.extend("cc.spreadsheetimporter.v2_3_0.SheetHandler", {
    constructor: function _constructor() {
      ManagedObject.prototype.constructor.call(this);
    }
  });
  SheetHandler.sheet_to_json = function sheet_to_json(sheet, opts, readSheetCoordinates) {
  ...
  SheetHandler.fmt_is_date = function fmt_is_date(fmt) {
    var i = 0,
      /*cc = 0,*/c = '',
      o = '';
    while (i < fmt.length) {
  ...
  SheetHandler.SSF_isgeneral = function SSF_isgeneral(s, i) {
    i = i || 0;
    return s.length >= 7 + i && (s.charCodeAt(i) | 32) === 103 && (s.charCodeAt(i + 1) | 32) === 101 && (s.charCodeAt(i + 2) | 32) === 110 && (s.charCodeAt(i + 3) | 32) === 101 && (s.charCodeAt(i + 4) | 32) === 114 && (s.charCodeAt(i + 5) | 32) === 97 && (s.charCodeAt(i + 6) | 32) === 108;
  };
  SheetHandler.numdate = function numdate(v) {
    if (v >= 60 && v < 61) return v;
    var out = new Date();
    out.setTime((v > 60 ? v : v + 1) * 24 * 60 * 60 * 1000 + dnthresh);
    return out;
  };
  SheetHandler.utc_to_local = function utc_to_local(utc) {
   ...
   */
  SheetHandler.applyCoordinatesToRange = function applyCoordinatesToRange(range, cellReference) {
    try {
...
//# sourceMappingURL=SheetHandler-dbg.js.map
