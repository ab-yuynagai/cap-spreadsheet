sap.ui.define(["sap/base/Log", "./OData", "./MetadataHandlerV2", "sap/ui/model/odata/v2/ODataListBinding"], function (Log, __OData, __MetadataHandlerV2, ODataListBinding) {
   ...
   */
  const ODataV2 = OData.extend("cc.spreadsheetimporter.v2_3_0.ODataV2", {
    ...
    getOdataType: async function _getOdataType(binding, odataType) {
      if (!odataType) {
    ...
    getObjects: function _getObjects(model, binding, batch) {
      throw new Error('Method not implemented.');
    },
    getLabelList: async function _getLabelList(columns, odataType, excludeColumns, binding) {
    ...
    getODataEntitiesRecursive: function _getODataEntitiesRecursive(entityName, deepLevel) {
