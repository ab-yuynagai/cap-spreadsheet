sap.ui.define(["cc/spreadsheetimporter/v2_3_0/thirdparty/xlsx", "sap/base/Log"], function (XLSX, Log) {
  "use strict";
  ...
  class TextToWorkbookService {
    ...
    async processClipboardData(clipboardData) {
      try {
        ...
        Log.error('Error processing clipboard data', error, 'TextToWorkbookService');
        return {
          workbook: null,
          type: 'none'
        };
    ...
    isSpreadsheetFile(file) {
      const supportedTypes = ['application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
      // .xlsx
     ...
     */
    convertTextToWorkbook(textData) {
      try {
        ...
        Log.error('Error converting text to workbook', error, 'TextToWorkbookService');
        throw error;
      }
    }
  ...
  return TextToWorkbookService;
});
//# sourceMappingURL=TextToWorkbookService-dbg.js.map
