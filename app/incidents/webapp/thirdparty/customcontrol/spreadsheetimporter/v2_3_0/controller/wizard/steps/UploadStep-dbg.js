sap.ui.define(["sap/m/MessageToast", "sap/base/Log"], function (MessageToast, Log) {
  "use strict";
  ...
  class UploadStep {
    stepName = 'uploadStep';
    // Util instance for i18n

    constructor(wizardController, wizard, util) {
    ...
    async onFileUpload(event) {
      try {
        ...
        Log.error('Error handling file upload', error, 'UploadStep');
    ...
    resetWizardProgress() {
      try {
        ...
        Log.warning('Error resetting wizard progress', error, 'UploadStep');
      }
    }
     ...
     */
    async processFileAndNavigate(file) {
      try {
        ...
        Log.error('Error processing file', error, 'UploadStep');
